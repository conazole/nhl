...
- REMOVED same day, do not re-add (user 2026-07-20: "tacky"): the slip's bet-window lamp line (goalie-confirmation status + first-puck countdown) and the ⤢ focus button. the slip is legs only. goalie confirmation still lives in each game card's team rows and pick panel.
